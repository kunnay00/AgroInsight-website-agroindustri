...
<div class="card-body">
    ...
    <div class="row-mb-3">
        <div class="col-lg-3">
            ...
            <?php echo (isset($set_halaman_depan)) ? 'checked': ''?>/>Beranda?</div>
        <div class="col-lg-3">
            <input type='checkbox' name="set_halaman_kontak" value="1"
            <?php echo (isset($set_halaman_kontak)) ? 'checked': ''?> />Tentang Kami?</div>
        <div class="col-lg-3">
            <input type='checkbox' name="set_halaman_tren" value="1"
            <?php echo (isset($set_halaman_tren)) ? 'checked': ''?> />Tren?</div>
        <div class="col-lg-3">
            <input type='checkbox' name="set_halaman_tips" value="1"
            <?php echo (isset($set_halaman_tips)) ? 'checked': ''?> />Tips?</div>
        <div class="col-lg-3">
            <input type='checkbox' name="set_halaman_agenda" value="1"
            <?php echo (isset($set_halaman_agenda)) ? 'checked': ''?> />Agenda?</div>
    <div>
