                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputKonfirmasiPassword" type="password" placeholder="Password" name="konfirm password" />
                                                <label for="inputPassword">Konfirm Password</label>
                                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; AgroInsight 2023</div>
                            <div>
