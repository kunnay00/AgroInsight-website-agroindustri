...
class PostsModel extends Model
{
    ...
    protected $allowedFields = ['username', 'post_title', 'post_title_seo', 'post_status', 'post_category', 'post_type', 'post_thumbnail', 'post_description', 'post_content'];
    ...
    function listPost($post_type, $jumlahBaris, $katakunci = null, $group_dataset = null)
    {
        ...
        // query = "select * from posts where post_type='artikel' and (post_title like '%hello%' or post_description like '%hello%')
        $builder->groupStart();
